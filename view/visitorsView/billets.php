...
<?php ob_start(); ?>
    <div class="container-fluid p-0">
        ...
        <div class="container-fluid bg-white">
            <form class="d-flex justify-content-center align-items-center flex-wrap row col-md-10 col-sm-12 offset-md-1 py-3 my-1" method="post" action="controller/formCall/addComment.php">
