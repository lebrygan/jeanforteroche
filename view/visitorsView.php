    ...
    <div class="container-fluid p-0">
        ...
        <div class="comments container-fluid justify-content-center text-center p-0">
            <?php
                if(count($comments) > 0 ){
                    if(count($comments) == 1){
                        echo '<h3 class="col-sm-12 my-1 pb-4 pt-2"> Une réponse à ce billet</h3>';
                    }else{
                        echo '<h3 class="col-sm-12 my-1 pb-4 pt-2">'.count($comments).' réponses à ce billet</h3>';
                    }
                }
                foreach ($comments as $comment) {
                    echo '<div class="comment d-flex justify-content-center align-items-center flex-wrap row col-sm-12 mx-0 my-1 p-1">';
